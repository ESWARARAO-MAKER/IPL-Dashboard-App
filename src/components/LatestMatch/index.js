        ...
        <div className="latest-match-card">
          ...
          <div className="latest-match-details-info">
            <div className="match-info-item">
              ...
              <p className="latest-match-details-venue">{firstInnings}</p>
            </div>
            <div className="match-info-item">
              <p className="latest-match-details-label">Second Innings</p>
              <p className="latest-match-details-venue">{secondInnings}</p>
            </div>
            <div className="match-info-item">
              <p className="latest-match-details-label">Man of the Match</p>
              <p className="latest-match-details-venue">{manOfTheMatch}</p>
            </div>
            <div className="match-info-item">
              <p className="latest-match-details-label">Umpires</p>
              <p className="latest-match-details-venue">{umpires}</p>
            </div>
          </div>
        </div>
      </div>
